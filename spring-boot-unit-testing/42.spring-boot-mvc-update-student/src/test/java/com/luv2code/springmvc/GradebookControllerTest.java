...
public class GradebookControllerTest {
    ...
    public static void setup() {
        ...
        request.setParameter("lastname", "Tublin");
        request.setParameter("emailAddress", "erictublin@rediff.net");
    }
    ...
    public void getStudentsHttpRequest() throws Exception {
        CollegeStudent studentOne = new GradebookCollegeStudent("Eric", "Roby", "ericroby@yahoo.com");
        CollegeStudent studentTwo = new GradebookCollegeStudent("Kara", "Bish", "kbish@rediff.net");
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("ericroby@yahoo.com");
    ...
    public void studentInformationHttpStudentDoesNotExistRequest() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get("/studentInformation/{id}", 5))
                .andExpect(status().isOk()).andReturn();
        ModelAndView mav = mvcResult.getModelAndView();
        assertViewName(mav, "error");
    }
