...
public class StudentAndGradeServiceTest {
    ...
    public void setupDatabase() {
        ...
        jdbc.execute("insert into math_grade(id,student_id,grade) values (0,1,100.00)");
        jdbc.execute("insert into science_grade(id,student_id,grade) values (0,1,100.00)");
        jdbc.execute("insert into history_grade(id,student_id,grade) values (0,1,100.00)");
    }
