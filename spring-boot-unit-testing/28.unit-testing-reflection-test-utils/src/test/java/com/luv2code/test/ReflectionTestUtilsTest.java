...
public class ReflectionTestUtilsTest {
    ...
    public void studentBeforeEach() {
        ...
        studentOne.setEmailAddress("ericdoe@yahoo.com");
    ...
    public void invokePrivateMethod() {
        assertEquals("Eric 1", ReflectionTestUtils.invokeMethod(studentOne, "getFirstNameAndId"), "Fail private method call");
    }
