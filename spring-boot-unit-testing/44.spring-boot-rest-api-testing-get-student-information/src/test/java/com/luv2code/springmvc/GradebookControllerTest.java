...
public class GradebookControllerTest {
    ...
    public static void setup() {
        ...
        request.setParameter("emailAddress", "eric.roby@yahoo.com");
    }
    ...
    public void getStudentHttpRequest() throws Exception {
        ...
        student.setLastname("Borne");
        student.setEmailAddress("jackbourne@yahoo.com");
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        mockMvc.perform(post("/")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$", hasSize(2)));
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("jackbourne@yahoo.com");
    ...
    public void studentInformationHttpRequest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/studentInformation/{id}", 1))
                ...
                .andExpect(jsonPath("$.emailAddress", is("eric.roby@yahoo.com")));
    }
    ...
    @Test
    public void createANonValidGradeHttpRequestGradeTypeDoesNotExisstEmptyResponse() throws Exception {
        this.mockMvc.perform(post("/grades")
                .contentType(MediaType.APPLICATION_JSON)
                .param("grade", "85.00")
