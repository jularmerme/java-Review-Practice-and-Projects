...
public class ApplicationExampleTest {
    ...
    public void beforeEach() {
        ...
        student.setEmailAddress("eric.roby@testemail.com");
    ...
    @Test
    public void chechNullForStudentGrades() {
    ...
    public void createStudentWithoutGradesInit() {
        ...
        studentTwo.setFirstname("Bart");
        studentTwo.setLastname("Simpson");
        studentTwo.setEmailAddress("bsimpson@yahoo.com");
    ...
    @DisplayName("Verifiy students are prototypes")
    @Test
